        ...
        public async Task<bool> Down()
        {
            ...
            try
            {
                ...
                if (IsLive)
                {
                    ...
                    {
                        LOGGER.PrintLine(stringscore.recordLimitReached, LOGGER.Warning);
                        LOGGER.WriteLine(stringscore.recordLimitReached);
                ...
                if (File.Exists(savePath) && Global.ShouldStop == false) 
                {
                    ...
                    {
                        LOGGER.WriteLineError(stringscore.SomethingWasWrong);
                        LOGGER.PrintLine(stringscore.SomethingWasWrong, LOGGER.Error);
                        return IsDone;
                    }
                    return IsDone;
                }
