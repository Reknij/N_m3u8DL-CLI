    ...
    class Global
    {
        ...
        public static void CheckUpdate()
        {
            try
            {
                ...
                {
                    Console.Title = string.Format(stringscore.newerVisionDetected, latestVer);
                    try
                    {
                        //尝试下载新版本
        ...
        {
            LOGGER.WriteLine(stringscore.readingFileInfo);
            LOGGER.PrintLine(stringscore.readingFileInfo, LOGGER.Warning);
            StringBuilder sb = new StringBuilder();
