...
namespace N_m3u8DL_CLI_core
{
    class Program
    {
        ...
        //    {
        //        case 0:
        //            LOGGER.WriteLine(stringscore.ExitedCtrlC
        //            + "\r\n\r\nTask End: " + DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss")); //Ctrl+C关闭
        //            break;
        //        case 2:
        //            LOGGER.WriteLine(stringscore.ExitedForce
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                Console.WriteLine(stringscore.ffmpegLost);
                Console.ResetColor(); //将控制台的前景色和背景色设为默认值
                Console.WriteLine(stringscore.ffmpegTip);
                Console.WriteLine();
                Console.WriteLine("http://ffmpeg.org/download.html#build-windows");
                Console.WriteLine();
                Console.WriteLine(stringscore.pressAnyKeyExit);
                Console.ReadKey();
                Environment.Exit(-1);
            }
        ...
        private static void DoWork(MyOptions o)
        {
            ...
            input:
                ...
                LOGGER.PrintLine($"{stringscore.fileName}{fileName}");
                LOGGER.PrintLine($"{stringscore.savePath}{Path.GetDirectoryName(Path.Combine(workDir, fileName))}");
                ...
                {
                    LOGGER.PrintLine(stringscore.parseExit);
                    Environment.Exit(0);
                }
                ...
                else
                {
                    ...
                    LOGGER.PrintLine(stringscore.InvalidUri, LOGGER.Error);
                    inputRetryCount--;
                    goto input;
                }
                ...
                if (isVOD == false)
                {
                    LOGGER.WriteLine(stringscore.liveStreamFoundAndRecoding);
                ...
                LOGGER.WriteLineError(stringscore.downloadFailed);
                LOGGER.PrintLine(stringscore.downloadFailed, LOGGER.Error);
                Thread.Sleep(3000);
                Environment.Exit(-1);
